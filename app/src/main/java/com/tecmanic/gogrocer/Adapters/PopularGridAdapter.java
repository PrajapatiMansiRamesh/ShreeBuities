...
public class PopularGridAdapter extends RecyclerView.Adapter<PopularGridAdapter.MyViewHolder> {
    ...
    public PopularGridAdapter(List<NewCategoryDataModel> categoryGridList, Context context, Categorygridquantity categorygridquantity) {
