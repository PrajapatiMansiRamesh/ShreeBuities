...
public class OtpVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show();
        sessionManagement = new Session_management(OtpVerification.this);
        init();
    ...
    private void otpUrl() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseURL.SignUpOtp, response -> {
            try {
