...
public class EditAddress extends AppCompatActivity {
    ...
    private void init() {
        session_management = new Session_management(com.tecmanic.gogrocer.activity.EditAddress.this);
...
//                Log.d("socetyId",houseNo.getText().toString());
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(com.tecmanic.gogrocer.activity.EditAddress.this);
