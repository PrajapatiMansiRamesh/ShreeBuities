...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void hitService() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseURL.SignUp, response -> {
            try {
                ...
                if (status.equalsIgnoreCase("1")) {
                    ...
                    sessionManagement.createLoginSession(id, userEmail1, userName1, userPhone1, password, false, "");
